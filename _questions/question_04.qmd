...
The series IDs for seasonally adjusted and unadjusted unemployment rates are `UNRATE` and `UNRATEUSA`, respectively. You can find the information either through the FRED website or `fredr_series_search_text()`.
